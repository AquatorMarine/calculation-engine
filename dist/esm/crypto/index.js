...
export function aesDecrypt(cipherText, iv, key) {
    const decrypted = CryptoJS.AES.decrypt({ ciphertext: CryptoJS.enc.Base64.parse(cipherText) }, normalizeKey(key), {
...
export function encryptObjectValues(data, key, fields) {
...
export function decryptObjectValues(data, key, fields) {
    if (!data || typeof data !== "object")
        return data;
